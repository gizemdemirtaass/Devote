...
//  DevoteWidget
//
//  Created by gizem demirtas on 4.10.2024.
//
...
struct DevoteWidgetEntryView : View {
    ...
    @Environment(\.widgetFamily) var widgetFamily //Herhangi bir widget örneğinin gerçek boyutunu alabiliriz!
...
/*struct DevoteWidget_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            DevoteWidgetEntryView(entry: SimpleEntry(date: .now, emoji: "😀"))
